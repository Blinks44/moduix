...
| --------- | -------------------------------- | --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| P1        | Переход с shadcn                 | ✅ Готово, 02.08.2026 | [Центральная migration-страница](../website/docs/en/docs/migrate-from-shadcn.mdx) с картой компонентов, imports, styling и ownership.                               |
| P1        | React stacks compatibility       | ✅ Готово, 02.08.2026 | [Quick start](../website/docs/en/docs/quick-start.mdx) с плитками и шесть страниц в свёрнутой группе: Vite, Rsbuild, TanStack Start, React Router, Astro и Next.js. |
...
Создана единая страница [Migrate from shadcn](../website/docs/en/docs/migrate-from-shadcn.mdx).
...
[Quick start](../website/docs/en/docs/quick-start.mdx) оставлен единым коротким входом и получил
