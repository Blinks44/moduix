...
<template>
  <Accordion :class="$style.root" :default-value="['what-is-ark-ui']" collapsible>
...
<style module src="../../../src/components/examples/accordion/accordion-collapsible.module.css" />