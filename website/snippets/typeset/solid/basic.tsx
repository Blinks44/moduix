...
export default function TypesetDemo() {
    ...
    <Typeset
      asChild={(props) => (
        <article {...props()}>
          ...
          <p>
            Write a normal <code>ul</code> for bullets-no utility class is required. Nested lists
            use a distinct marker, so their structure stays easy to scan.
          </p>
          <ul>
            <li>
  ...
  <article>{content}</article>
          ...
          <details open>
            ...
            <p>
              It does not parse Markdown, sanitize untrusted HTML, or choose the page layout. It
              only gives the semantic elements you render a consistent visual treatment.
            </p>
          </details>
        </article>
      )}
