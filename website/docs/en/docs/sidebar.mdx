...
import SidebarBasic from './_snippets/sidebar/basic.tsx';
import SidebarCustomScrollArea from './_snippets/sidebar/custom-scroll-area.tsx';
import SidebarCustomSizes from './_snippets/sidebar/custom-sizes.tsx';
import SidebarNestedNavigation from './_snippets/sidebar/nested-navigation.tsx';
import SidebarNestedNavigationAndAccountMenu from './_snippets/sidebar/nested-navigation-and-account-menu.tsx';
import SidebarPersistedLayout from './_snippets/sidebar/persisted-layout.tsx';
import SidebarRightSidebar from './_snippets/sidebar/right-sidebar.tsx';
import SidebarWorkspaceSelect from './_snippets/sidebar/workspace-select.tsx';
...
```tsx file="./_snippets/sidebar/basic.tsx"
```
...
```tsx file="./_snippets/sidebar/nested-navigation.tsx"
```
...
```tsx file="./_snippets/sidebar/custom-scroll-area.tsx"
```
...
```tsx file="./_snippets/sidebar/persisted-layout.tsx"
```
...
```tsx file="./_snippets/sidebar/nested-navigation-and-account-menu.tsx"
```
...
```tsx file="./_snippets/sidebar/right-sidebar.tsx"
```
...
```tsx file="./_snippets/sidebar/workspace-select.tsx"
```
...
```tsx file="./_snippets/sidebar/custom-sizes.tsx"
```
