...
import styles from '@/components/examples/accordion/accordion-collapsible.module.css';
...
export default function CollapsibleAccordionDemo() {
  return (
    <Accordion className={styles.root} collapsible defaultValue={['what-is-ark-ui']}>
      {items.map((item) => (
