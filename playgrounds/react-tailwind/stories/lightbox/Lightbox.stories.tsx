    ...
    return (
      <div className={stackClass}>
        ...
        <Lightbox open={open} onOpenChange={(details) => setOpen(details.open)}>
          <Lightbox.Trigger className={textTriggerClass}>Open controlled lightbox</Lightbox.Trigger>
...
export const ClickToCloseImage: Story = {
  render: () => (
    <Lightbox>
      <Lightbox.Trigger className={textTriggerClass}>Open click-to-close lightbox</Lightbox.Trigger>
...
export const CustomStyling: Story = {
  render: () => (
    <Lightbox>
      <Lightbox.Trigger className={textTriggerClass}>Open styled lightbox</Lightbox.Trigger>
      <Lightbox.Backdrop className="bg-slate-900/70" />
      <Lightbox.Positioner>
        <Lightbox.CloseIcon className="rounded-md bg-muted [@media(hover:hover)]:hover:bg-accent" />
        <Lightbox.Content className="max-h-[72dvh] max-w-[72vw]" aria-label={images[1].alt}>
          <Lightbox.Body>
