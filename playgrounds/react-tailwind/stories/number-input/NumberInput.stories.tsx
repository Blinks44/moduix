...
export const CustomIcons: Story = {
  render: () => (
    ...
    >
      ...
      <NumberInputControl>
        <NumberInputDecrementTrigger className="bg-muted [&>svg]:size-4 [@media(hover:hover)]:hover:bg-accent">
          <ChevronDownIcon />
        </NumberInputDecrementTrigger>
        <NumberInputInput className="w-28 text-lg" />
        <NumberInputIncrementTrigger className="bg-muted [&>svg]:size-4 [@media(hover:hover)]:hover:bg-accent">
          <ChevronUpIcon />
        </NumberInputIncrementTrigger>
      </NumberInputControl>
    </NumberInput>
