  ...
  render: () => {
    ...
    return (
      <ProgressLinearRootProvider value={progress}>
        ...
        >
          <ProgressLinearRange className="rounded-[inherit] bg-linear-to-r from-chart-3 to-primary" />
        </ProgressLinearTrack>
      </ProgressLinearRootProvider>
    );
  },
...
export const CustomStyles: Story = {
  render: () => (
    <ProgressLinear defaultValue={72} className="w-64">
      ...
      >
        <ProgressLinearRange className="bg-linear-to-r from-primary to-chart-2" />
      </ProgressLinearTrack>
    </ProgressLinear>
  ),
};
