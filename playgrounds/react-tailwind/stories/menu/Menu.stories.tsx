...
function MapIcon(props: ComponentProps<'svg'>) {
  return (
    <svg
...
function DefaultPositionedContent({ children }: { children: ReactNode }) {
  return (
    <MenuPositioner>
      <MenuContent>
        <MenuViewport>{children}</MenuViewport>
      </MenuContent>
    </MenuPositioner>
  );
}
...
export const CustomStyling: Story = {
  render: () => (
    <Menu positioning={{ placement: 'right-start', gutter: 12 }}>
      ...
      <MenuPositioner>
        <MenuContent className="min-w-52 bg-background outline-primary [&_[data-highlighted]]:text-primary-foreground [&_[data-highlighted]]:before:bg-primary [&_[data-slot='menu-separator']]:bg-primary">
          <MenuViewport>
            <MenuItem value="png">Export PNG</MenuItem>
            <MenuItem value="pdf">Export PDF</MenuItem>
            <MenuSeparator />
