...
export const Semantics: Story = {
  render: () => (
    <div className="flex w-[min(34rem,calc(100vw_-_2rem))] flex-col gap-3">
...
export const Aligned: Story = {
  render: () => (
    <div className="flex w-[min(34rem,calc(100vw_-_2rem))] flex-col gap-4">
...
export const Truncation: Story = {
  render: () => (
    <div className="flex w-[min(18rem,calc(100vw_-_2rem))] flex-col gap-4">
