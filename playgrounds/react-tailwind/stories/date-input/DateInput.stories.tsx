...
export const WithFieldValidation: Story = {
  render: () => (
    <div className="grid gap-2">
      ...
      <span className="text-sm leading-5 text-destructive">Enter a valid deadline.</span>
    </div>
  ),
};
...
export const CustomStyling: Story = {
  render: () => (
    <DateInput defaultValue={[new CalendarDate(2026, 6, 22)]}>
      ...
      <DateInput.Control className="border-primary bg-muted focus-within:outline-primary data-focus:outline-primary">
