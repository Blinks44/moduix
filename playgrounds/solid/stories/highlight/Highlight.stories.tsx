...
export const MatchAll: Story = {
  render: () => (
    <div class={storyStyles.comparison}>
      <div>
        <div class={storyStyles.label}>Match all</div>
        <Text>
          <Highlight
            matchAll
            query="component"
      ...
      <div>
        <div class={storyStyles.label}>First match only</div>
        <Text>
          <Highlight
            matchAll={false}
            query="component"
...
export const ExactMatch: Story = {
  render: () => (
    <div class={storyStyles.comparison}>
      <div>
        <div class={storyStyles.label}>Partial match</div>
        <Text>
          <Highlight
            matchAll
            query="box"
      ...
      <div>
        <div class={storyStyles.label}>Exact match</div>
        <Text>
          <Highlight
            exactMatch
            matchAll
