...
export const CustomStyles: Story = {
  render: () => (
    ...
    >
      <ToggleGroupItem value="day" class={storyStyles.customItem}>
        Day
      </ToggleGroupItem>
      <ToggleGroupItem value="week" class={storyStyles.customItem}>
        Week
      </ToggleGroupItem>
      <ToggleGroupItem value="month" class={storyStyles.customItem}>
        Month
      </ToggleGroupItem>
    </ToggleGroup>
  ),
