...
export const CustomStyles: Story = {
  render: () => (
    <Fieldset class={styles.customFieldset}>
      <Fieldset.Legend class={styles.customLegend}>Styled fieldset</Fieldset.Legend>
      <Field.Root class={styles.customField}>
        <Field.Label class={styles.customLabel}>Project name</Field.Label>
        <Field.Input placeholder="Maps Platform" class={styles.customControl} />
      </Field.Root>
      <Fieldset.HelperText class={styles.customHelper}>
