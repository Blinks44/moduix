    ...
    return (
      <div class="flex w-[min(28rem,calc(100vw-2rem))] flex-col items-start gap-4">
        ...
        <div
          ...
          class="grid min-h-20 w-full place-items-center rounded-lg border border-border bg-muted text-sm leading-5 text-foreground"
        >
          Target element
        </div>
        <TourOverlay tour={tour} />
  ...
  render: () => {
    ...
    return (
      <div class="flex w-[min(28rem,calc(100vw-2rem))] flex-col items-start gap-4">
        ...
        <div
          class="min-h-20 w-full rounded-md border border-border bg-muted p-3 font-mono text-xs leading-4 text-muted-foreground"
          aria-live="polite"
        >
    ...
    return (
      <div class="flex w-[min(28rem,calc(100vw-2rem))] flex-col items-start gap-4">
        ...
        <label class="grid w-full max-w-80 gap-1 text-sm leading-5 font-medium text-foreground">
          ...
          <input
            id="tour-story-name"
            class="min-h-control-lg rounded-md border border-border bg-background px-3 text-foreground outline-0 focus-visible:outline-1 focus-visible:-outline-offset-1 focus-visible:outline-ring"
          />
        </label>
        <TourOverlay tour={tour} />
      </div>
