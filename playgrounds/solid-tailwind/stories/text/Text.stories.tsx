...
export const Semantics: Story = {
  render: () => (
    <div class="flex w-[min(34rem,calc(100vw_-_2rem))] flex-col gap-3">
...
export const CustomElement: Story = {
  ...
  render: () => (
    <Text
      ...
      asChild={(props) => (
        <a {...props()} href="#">
          Text rendered through a custom link element.
        </a>
      )}
    />
  ),
...
export const Aligned: Story = {
  render: () => (
    <div class="flex w-[min(34rem,calc(100vw_-_2rem))] flex-col gap-4">
...
export const Truncation: Story = {
  render: () => (
    <div class="flex w-[min(18rem,calc(100vw_-_2rem))] flex-col gap-4">
