...
export const CustomStyling: Story = {
  render: () => (
    <Slider defaultValue={[56]} class={customSliderClass}>
      ...
      <Slider.ValueText />
      <Slider.Control class={customControlClass}>
        <Slider.Track class={customTrackClass}>
          <Slider.Range class={customRangeClass} />
        </Slider.Track>
        <Slider.Thumb index={0} aria-label="Temperature" class={customThumbClass}>
          <Slider.HiddenInput />
        </Slider.Thumb>
      </Slider.Control>
    </Slider>
