...
const contentStressClass = 'grid w-[min(18rem,calc(100vw_-_2rem))] gap-3';
const wrappingButtonClass = 'whitespace-normal';
...
export const ContentStress: Story = {
  render: () => (
    <div class={contentStressClass}>
      <Button class={wrappingButtonClass}>Approve the updated account recovery settings</Button>
      <Button class={wrappingButtonClass} dir="rtl" variant="outline">
