...
const ImageSlide = defineComponent({
  props: {
    ...
    style: { type: [Object, String, Array], default: undefined },
  },
  setup(props) {
    return { cn, imageClass, props };
  },
  template: `
  ...
  render: renderStory(`
    <div :class="frameClass">
      ...
      >
        ...
        <CarouselControl :class="controlsClass">
          <CarouselPrevTrigger />
          <CarouselNextTrigger />
        </CarouselControl>
        <CarouselIndicators />
    ...
    <div :class="frameClass">
      ...
      >
        <CarouselContext v-slot="api">
          ...
          <CarouselItemGroup @focusin="api.pause()" @pointerenter="api.pause()" @pointerleave="api.play()">
            <CarouselItem v-for="(slide, index) in slides" :key="slide.id" :index="index">
              <ImageSlide :src="slide.image" :alt="slide.alt" />
            </CarouselItem>
          </CarouselItemGroup>
          <CarouselControl :class="controlsClass" @focusin="api.pause()" @pointerenter="api.pause()" @pointerleave="api.play()">
            <CarouselAutoplayTrigger>
    ...
    <div :class="frameClass">
      ...
      >
        ...
        <CarouselItemGroup aria-label="Two-up image carousel">
          <CarouselItem v-for="(slide, index) in slides" :key="slide.id" :index="index">
            <ImageSlide :class="shortImageClass" :src="slide.image" :alt="slide.alt" />
          </CarouselItem>
        </CarouselItemGroup>
        <CarouselIndicators />
      </Carousel>
  ...
  render: renderStory(`
    <div :class="frameClass">
      ...
      >
        ...
        <CarouselIndicatorGroup class="flex-wrap">
          <CarouselIndicator
    ...
    <div :class="frameClass">
      ...
      >
        ...
        <CarouselItemGroup aria-label="Variable image carousel">
          <CarouselItem
            v-for="(slide, index) in variableSlides"
            :key="slide.id"
            :index="index"
            snap-align="center"
          >
    ...
    <div :class="frameClass">
      ...
      >
        <CarouselItemGroup aria-label="Vertical image carousel">
          <CarouselItem v-for="(slide, index) in slides" :key="slide.id" :index="index">
            <ImageSlide class="h-full" :src="slide.image" :alt="slide.alt" />
          </CarouselItem>
        </CarouselItemGroup>
        <CarouselControl>
          <CarouselPrevTrigger />
