...
export const Basic: Story = {
  render: renderStory(`
    <Accordion :default-value="['what-is-ark-ui']" :class="demoRootClass">
      <FaqAccordionItems />
    </Accordion>
  `),
};
...
export const Collapsible: Story = {
  render: renderStory(`
    <Accordion :default-value="['what-is-ark-ui']" collapsible :class="demoRootClass">
      <FaqAccordionItems />
    </Accordion>
  `),
};
  ...
  render: renderStory(`
    <Accordion :default-value="['what-is-ark-ui']" :class="demoRootClass">
      <AccordionContext v-slot="context">
        <output :class="stateClass">Open sections: {{ context.value.join(', ') }}</output>
      </AccordionContext>
...
export const Controlled: Story = {
  render: renderStory(
    `
      <Accordion v-model="value" :class="demoRootClass">
        <FaqAccordionItems />
      </Accordion>
    `,
...
export const Horizontal: Story = {
  render: renderStory(`
    <Accordion orientation="horizontal" :default-value="['what-is-ark-ui']" :class="demoRootClass">
      <FaqAccordionItems />
    </Accordion>
  `),
};
...
export const LazyMount: Story = {
  render: renderStory(`
    <Accordion lazy-mount unmount-on-exit :class="demoRootClass"><FaqAccordionItems /></Accordion>
  `),
};

export const Multiple: Story = {
  render: renderStory(`
    <Accordion multiple :default-value="['what-is-ark-ui', 'can-i-use-it']" :class="demoRootClass">
      <FaqAccordionItems />
    </Accordion>
  `),
};
...
export const RootProvider: Story = {
  render: renderStory(
    `
      ...
      <AccordionRootProvider :value="accordion" :class="demoRootClass"><FaqAccordionItems /></AccordionRootProvider>
    `,
...
export const ContentStress: Story = {
  render: renderStory(`
    <Accordion :default-value="['long-content']" :class="demoRootClass">
...
export const CustomStyling: Story = {
  render: renderStory(`
    <Accordion :default-value="['what-is-ark-ui']" :class="demoRootClass">
      <FaqAccordionItems custom-icon :icon-class="customIconClass" />
    </Accordion>
  `),
};