...
export const AdvancedCustomization: Story = {
  render: () => {
    ...
    return defineComponent({
      components: alertComponents,
      setup() {
        return { customAlertClassName, customIndicatorClassName, dismiss, stackClassName, visible };
      },
      template: `
        <div :class="stackClassName">
          <Alert v-if="visible" status="warning" :class="customAlertClassName">
            <AlertIndicator :class="customIndicatorClassName"><InfoIcon /></AlertIndicator>
            <AlertContent>
