...
const MenuButtonTrigger = defineComponent({
  components: { Button, MenuTrigger },
  template: '<MenuTrigger as-child><Button><slot /></Button></MenuTrigger>',
});

const DefaultPositionedContent = defineComponent({
  components: { MenuContent, MenuPositioner, MenuViewport },
  template:
    '<MenuPositioner><MenuContent><MenuViewport><slot /></MenuViewport></MenuContent></MenuPositioner>',
});
  ...
  render: renderStory(
    `
      <MenuRootProvider :value="menu">
        <Button @click="highlightCopy">Highlight Copy</Button>
        <MenuButtonTrigger>
          Edit
          <MenuIndicator />
        </MenuButtonTrigger>
    ...
    () => {
      ...
      return {
        menu,
        highlightCopy: () => menu.api.value.setHighlightedValue('copy'),
      };
    },
  ),
};
      ...
      <Menu>
        ...
        <DefaultPositionedContent>
          <MenuItemGroup>
            ...
            <MenuRadioItemGroup v-model="sortBy">
          ...
          <MenuItemGroup>
            ...
            <MenuCheckboxItem v-model:checked="showMinimap" value="minimap">
              <MenuItemIndicator />
              <MenuItemText>Minimap</MenuItemText>
            </MenuCheckboxItem>
            <MenuCheckboxItem v-model:checked="showSearch" value="search">
              <MenuItemIndicator />
              <MenuItemText>Search</MenuItemText>
            </MenuCheckboxItem>
            <MenuCheckboxItem v-model:checked="showSidebar" value="sidebar">
              <MenuItemIndicator />
...
export const WithShortcuts: Story = {
  render: renderStory(`
    <Menu>
      ...
      <DefaultPositionedContent>
        <MenuItem value="copy">Copy<MenuItemShortcut>Ctrl+C</MenuItemShortcut></MenuItem>
        <MenuItem value="paste">Paste<MenuItemShortcut>Ctrl+V</MenuItemShortcut></MenuItem>
        <MenuSeparator />
        <MenuItem value="rename">Rename<MenuItemShortcut>F2</MenuItemShortcut></MenuItem>
      </DefaultPositionedContent>
    </Menu>
  `),
};
  ...
  render: renderStory(
    `
      <Menu>
        ...
        <DefaultPositionedContent>
          <MenuCheckboxItem v-model:checked="showMinimap" value="minimap" indicator="end">
            <MenuItemText>
              <MenuItemTextContent>
                <MenuItemTextIcon><InfoIcon /></MenuItemTextIcon>
                <MenuItemTextLabel>Minimap</MenuItemTextLabel>
              </MenuItemTextContent>
            </MenuItemText>
            <MenuItemIndicator />
          </MenuCheckboxItem>
          <MenuCheckboxItem v-model:checked="showSearch" value="search" indicator="end">
            <MenuItemText>
              <MenuItemTextContent>
                <MenuItemTextIcon><MapIcon /></MenuItemTextIcon>
    ...
    `,
    () => ({ showMinimap: ref(true), showSearch: ref(true) }),
  ),
};
...
export const LinkItems: Story = {
  ...
  render: renderStory(`
    <Menu>
      ...
      <DefaultPositionedContent>
        <MenuItem value="projects" as-child><a href="#projects">Projects</a></MenuItem>
        <MenuItem value="teams" as-child><a href="#teams">Teams</a></MenuItem>
        <MenuItem value="billing" as-child><a href="#billing">Billing</a></MenuItem>
        <MenuSeparator />
