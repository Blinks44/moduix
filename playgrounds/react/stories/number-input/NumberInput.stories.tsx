...
export const CustomIcons: Story = {
  render: () => (
    ...
    >
      ...
      <NumberInputControl>
        <NumberInputDecrementTrigger className={storyStyles.customButton}>
          <ChevronDownIcon />
        </NumberInputDecrementTrigger>
        <NumberInputInput className={storyStyles.customInput} />
        <NumberInputIncrementTrigger className={storyStyles.customButton}>
          <ChevronUpIcon />
        </NumberInputIncrementTrigger>
      </NumberInputControl>
    </NumberInput>
