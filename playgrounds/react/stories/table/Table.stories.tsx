    ...
    <div className={styles.showcase}>
      <TableScrollArea>
        <Table showColumnBorder className={styles.table}>
          ...
          <TableBody>
            <TableRow>
              <TableCell className={styles.emphasis}>Laptop</TableCell>
              <TableCell>Electronics</TableCell>
              <TableCell numeric>$999.99</TableCell>
            </TableRow>
            <TableRow>
              <TableCell className={styles.emphasis}>Coffee Maker</TableCell>
              <TableCell>Home Appliances</TableCell>
              <TableCell numeric>$49.99</TableCell>
            </TableRow>
            <TableRow>
              <TableCell className={styles.emphasis}>Desk Chair</TableCell>
...
export const StickyHeaderAndColumn: Story = {
  render: () => (
    <div className={styles.showcase}>
      <TableScrollArea className={styles.stickyScrollArea}>
            ...
            {Array.from({ length: 10 }, (_, index) => projects[index % projects.length]).map(
              (project, index) => (
                <TableRow key={`${project.name}-${index}`}>
                  <TableCell data-sticky="start" className={styles.emphasis}>
                    {project.name}
                  </TableCell>
                  <TableCell>{project.owner}</TableCell>
