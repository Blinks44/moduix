...
export const paginationOverrideCssProperties: CssPropertyInput[] = [
  ...
  [
    '--pagination-line-height-xs',
    'var(--line-height-text-xs)',
    'Controls pagination line height for xs size.',
  ],
  [
    '--pagination-line-height-sm',
    'var(--line-height-text-xs)',
    'Controls pagination line height for sm size.',
  ],
  [
    '--pagination-line-height-md',
    'var(--line-height-text-sm)',
    'Controls pagination line height for md size.',
  ],
  [
    '--pagination-line-height-lg',
    'var(--line-height-text-md)',
    'Controls pagination line height for lg size.',
  ],
  [
    '--pagination-line-height-xl',
    'var(--line-height-text-lg)',
    'Controls pagination line height for xl size.',
  ],
