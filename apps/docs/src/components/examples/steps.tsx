...
export const stepsOverrideCssProperties: CssPropertyInput[] = [
  ...
  ['--steps-action-height', '2rem', 'Controls action button minimum height.'],
  ['--steps-action-line-height', 'var(--line-height-text-sm)', 'Controls action line height.'],
  ['--steps-action-padding-x', '0.75rem', 'Controls horizontal action padding.'],
  ['--steps-action-padding-y', '0.375rem', 'Controls vertical action padding.'],
  ...
  ['--steps-focus-ring-offset', '2px', 'Controls focus ring offset.'],
  ['--steps-focus-ring-width', 'var(--border-width-sm)', 'Controls focus ring width.'],
  ...
  [
    ...
    'var(--steps-indicator-border-color-current)',
  ...
  [
    ...
    'var(--steps-indicator-color-current)',
  ...
  ['--steps-indicator-icon-size', '0.875rem', 'Controls complete check icon size.'],
  ['--steps-indicator-radius', 'var(--radius-full)', 'Controls indicator radius.'],
  ['--steps-indicator-size', '2rem', 'Controls indicator width and height.'],
  ...
  ['--steps-separator-inset', '0.5rem', 'Controls separator inset from the indicator.'],
