...
export const floatingPanelOverrideCssProperties: CssPropertyInput[] = [
  ...
  ['--floating-panel-control-icon-size', '0.875rem', 'Default control icon size.'],
  ['--floating-panel-control-radius', 'var(--radius-sm)', 'Control button radius.'],
  ['--floating-panel-control-size', '1.625rem', 'Control button square size.'],
  ...
  ['--floating-panel-header-height', '2.75rem', 'Header minimum height.'],
  ...
  ['--floating-panel-resize-edge-size', '0.375rem', 'Edge resize handle thickness.'],
  ...
  ['--floating-panel-trigger-padding-x', '0.875rem', 'Default trigger horizontal padding.'],
