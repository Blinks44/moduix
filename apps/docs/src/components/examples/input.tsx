...
export const inputOverrideCssProperties: CssPropertyInput[] = [
  ...
  ['--input-height-xl', '3.5rem', 'Controls extra-large input height.'],
  ...
  ['--input-padding-x', 'var(--spacing-3)', 'Controls default horizontal padding.'],
  ...
  ['--input-padding-y', 'var(--spacing-2)', 'Controls default vertical padding.'],
  ['--input-padding-y-xs', 'var(--spacing-1)', 'Controls extra-small vertical padding.'],
  ['--input-padding-y-sm', 'var(--spacing-1)', 'Controls small vertical padding.'],
  ['--input-padding-y-md', 'var(--spacing-2)', 'Controls medium vertical padding.'],
  ['--input-padding-y-lg', 'var(--spacing-2)', 'Controls large vertical padding.'],
  ['--input-padding-y-xl', 'var(--spacing-3)', 'Controls extra-large vertical padding.'],
