...
export function BasicDataTableExample() {
  ...
  return (
    <Table.ScrollArea className={styles.root}>
...
export function InteractiveDataTableExample() {
              ...
              <Table.Row key={headerGroup.id}>
                {headerGroup.headers.map((header) => (
                  <Table.ColumnHeader
                    key={header.id}
                    colSpan={header.colSpan}
                    className={header.column.id === 'select' ? styles.selectionColumn : undefined}
                    numeric={header.column.id === 'amount'}
                    aria-sort={
              ...
              table.getRowModel().rows.map((row) => (
                <Table.Row key={row.id} data-selected={row.getIsSelected() || undefined}>
                  {row.getVisibleCells().map((cell) => (
                    <Table.Cell
                      key={cell.id}
                      className={cell.column.id === 'select' ? styles.selectionColumn : undefined}
