...
const treeViewOverrideCssProperties: CssPropertyInput[] = [
  ...
  [
    '--tree-view-indicator-icon-size',
    'var(--spacing-3-5)',
    'Customizes tree view indicator icon size.',
  ],
  ['--tree-view-indicator-size', 'var(--spacing-4)', 'Customizes tree view indicator size.'],
  ...
  ['--tree-view-item-min-height', 'var(--size-sm)', 'Controls branch and item row height.'],
  ...
  ['--tree-view-node-icon-size', 'var(--spacing-4)', 'Controls file and folder icon size.'],
  [
