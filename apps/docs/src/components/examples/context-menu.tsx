...
export const contextMenuOverrideCssProperties: CssPropertyInput[] = [
  ...
  [
    '--context-menu-backdrop-ending-blur',
    'none',
    'Controls backdrop blur at the end of exit motion.',
  ],
  [
    '--context-menu-backdrop-ending-opacity',
    '0',
    'Controls backdrop opacity at the end of exit motion.',
  ],
  [
    '--context-menu-backdrop-starting-blur',
    'none',
    'Controls backdrop blur at the start of enter motion.',
  ],
  [
    '--context-menu-backdrop-starting-opacity',
    '0',
    'Controls backdrop opacity at the start of enter motion.',
  ],
  [
  ...
  ['--context-menu-popup-ending-opacity', '0', 'Controls popup opacity at the end of exit motion.'],
  [
    '--context-menu-popup-ending-scale',
    'var(--scale-popup)',
    'Controls popup scale at the end of exit motion.',
  ],
  [
    '--context-menu-popup-ending-translate-x',
    '0',
    'Controls popup horizontal offset at the end of exit motion.',
  ],
  [
    '--context-menu-popup-ending-translate-y',
    '0',
    'Controls popup vertical offset at the end of exit motion.',
  ],
  ...
  [
    '--context-menu-popup-starting-opacity',
    '0',
    'Controls popup opacity at the start of enter motion.',
  ],
  [
    '--context-menu-popup-starting-scale',
    'var(--scale-popup)',
    'Controls popup scale at the start of enter motion.',
  ],
  [
    '--context-menu-popup-starting-translate-x',
    '0',
    'Controls popup horizontal offset at the start of enter motion.',
  ],
  [
    '--context-menu-popup-starting-translate-y',
    '0',
    'Controls popup vertical offset at the start of enter motion.',
  ],
