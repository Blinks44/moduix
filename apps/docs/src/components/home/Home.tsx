      ...
      <section className={styles.hero} aria-labelledby="home-title">
        <div className={styles.content}>
          ...
          <p className={styles.lead}>
            Accessible React components with calm defaults, explicit composition, and a token-first
            CSS foundation you can theme or own.
          </p>
          <FrameworkSupport />
          <div className={styles.actions}>
            ...
            <a href="/docs/components" className={styles.secondary}>
              Components
