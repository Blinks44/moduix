...
| `PopoverViewport`    | Optional viewport wrapper for animated or structured inner content.                                 |
...
Use the low-level parts directly when you need to control the structure, backdrop, viewport, or
arrow content.
