...
Use `indicator="end"` to align checkbox and radio indicators to the end. Text and icon slots accept
custom content and `className`. Use `indicator="none"` when the selected row should rely on
