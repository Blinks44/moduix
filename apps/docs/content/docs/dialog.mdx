...
Set `withCloseButton` for the built-in top-right close icon. Use manual `DialogCloseIcon` when you
need custom placement or icon replacement. For a viewport-level close control (outside popup
