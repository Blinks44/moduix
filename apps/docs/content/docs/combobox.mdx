...
| Popup placement                         | Pass `sideOffset` to `ComboboxContent` for the common case, or use the lower-level popup parts when you need full control. |
| Backdrop or arrow                       | Use the lower-level popup parts only for custom popup infrastructure.                                                      |
