...
If you want `OTP Field` to become part of your own project source instead of staying in
...
This install path also pulls in the shared moduix foundation files that `OTP Field` depends on, such
