...
moduix is a small React component library built for real product work. I started it for my own
...
the idea that components should be easy to read, copy mentally, and customize. moduix is simply the
shape that works well for my projects. If it fits yours too, I will be glad.
