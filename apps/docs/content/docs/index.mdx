...
| --------------------------- | ------------------------------------------------------------------------------------------ |
| npm package                 | You want the fastest setup, updates through package management, and imports from `moduix`. |
| `shadcn` copy-owned install | You want the component files inside your app and plan to customize them directly.          |
