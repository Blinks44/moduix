...
The CSS file includes the shared design tokens and base layer styles. It does not include the
optional reset, and component styles are loaded alongside the components you import.
