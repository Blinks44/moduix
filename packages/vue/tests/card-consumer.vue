...
<template>
  <Card size="sm" variant="elevated" aria-label="Release health">
    ...
    <CardHeader>
      <CardTitle as-child><h2>Release health</h2></CardTitle>
    ...
    <CardBody class="consumer-body">98.4% successful sessions</CardBody>
