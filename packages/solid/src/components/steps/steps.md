...
The public `--moduix-steps-*` contract is listed below. Keep it synchronized with `Steps.module.css`, `variables-moduix.css`, and the CSS Properties panel in the public docs.
