...
`Badge` preserves the React component's presentational root, explicit `BadgeLabel` and
`BadgeDot` parts, variants, stable data hooks, and consumer-owned interactive presentation.
