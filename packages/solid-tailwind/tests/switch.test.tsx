...
test('lets consumer Tailwind classes override conflicting defaults', () => {
  render(() => (
    <Switch class="gap-4" data-testid="root">
      <Switch.Control class="w-10 rounded-md bg-background p-1">
        <Switch.Thumb class="size-4 bg-muted-foreground" />
      </Switch.Control>
      <Switch.Label class="text-lg">Notifications</Switch.Label>
      <Switch.HiddenInput />
    </Switch>
  ));
