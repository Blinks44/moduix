...
test('keeps component-owned visual utilities and lets consumers override them', () => {
  render(() => (
    <ProgressCircular class="gap-0 text-primary" data-testid="progress-root">
      <ProgressCircular.Label class="text-lg">Export data</ProgressCircular.Label>
      <ProgressCircular.Circle class="[--size:4rem]" data-testid="progress-circle">
        <ProgressCircular.CircleTrack class="stroke-accent" data-testid="progress-track" />
        <ProgressCircular.CircleRange class="stroke-chart-2" data-testid="progress-range" />
      </ProgressCircular.Circle>
    </ProgressCircular>
  ));
