...
test('applies Tailwind defaults and lets consumer utilities win', () => {
  render(() => (
    <Dialog defaultOpen portalled={false}>
      <Dialog.Trigger class="bg-primary px-2">Open dialog</Dialog.Trigger>
      <Dialog.Backdrop />
      <Dialog.Positioner>
        <Dialog.Content class="w-96 bg-card p-4">
          <Dialog.Header>
            <Dialog.Title>Preferences</Dialog.Title>
            <Dialog.CloseIcon class="size-8 rounded-full bg-primary" />
