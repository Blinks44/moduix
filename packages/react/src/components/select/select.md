...
- `Field` is a narrow standard-control helper; `indicator` replaces only the default chevron, while popup positioning, content, items, and form submission stay explicit.
